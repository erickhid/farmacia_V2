<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RepFar.aspx.vb" Inherits="RepFar" %>
            ...
            <tr>
                ...
                <td style="width: 100px; background-color: #e9ecf1;">
                    <asp:DropDownList ID="DDL_tipoR" runat="server" CssClass="datos">
                        <asp:ListItem Value="1">MEDICAMENTO CON FRECUENCIA</asp:ListItem>         
                        <asp:ListItem Value="2">VISITAS</asp:ListItem>
                        <asp:ListItem Value="3">ESQUEMA</asp:ListItem>
                        <asp:ListItem Value="4">ESQUEMA PEDIATRICO</asp:ListItem>
                    </asp:DropDownList>
                </td>
                ...
                <td style="text-align:center" >
                    <asp:Button ID="btn_generar" runat="server" Text="Generar" TabIndex="60" Height="25" Width="85" CssClass="button01" />
                </td>
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="pnl_reporte" runat="server" BorderColor="#5d7b9d" BorderStyle="solid" BorderWidth="0px" ScrollBars="Auto" Width="698px">
                    <table id="tbl_reporte" runat="server" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td>
                                <asp:GridView ID="GV_reporte" runat="server" 
                                    CellPadding="1" 
                                    ForeColor="#333333" 
