Imports System.Data
Partial Class IngresoMed_Inventario
    ...
    End Sub
    Sub llenaMedARV(ByVal fecha_mes_min As String, ByVal fecha_mes_max As String, ByVal fecha_anio As String)
        Try
            db.Cn1 = cn1
            Dim I_MedARV As DataTable = db.Obtiene_ingresos_med_ARV(fecha_mes_min, fecha_mes_max, fecha_anio, usuario)
            Session("datosIMedARV") = I_MedARV
            GV_pnl_IngresoARV.DataSource = I_MedARV
            GV_pnl_IngresoARV.DataBind()
    ...
    Sub buscaMED(ByVal codigo As String, ByVal med As Integer)
        ...
        If rp(0).ToString() = "True" Then
            NomARV.Text = String.Empty
            NomARV.Text = rp(1).ToString() + "/" + rp(2).ToString() + "/" + rp(3).ToString()
        Else
    ...
    Protected Sub ibt_Agregar_Click(sender As Object, e As ImageClickEventArgs) Handles ibt_Agregar.Click
        ...
        If FechaEntrega <> Nothing Then
            ...
            NomARV.Text = Nothing
            txt_cantidadARV.Text = Nothing
            llenaMedARV(DDL_mes.SelectedValue.ToString(), DDL_mes.SelectedValue.ToString(), DDL_anio.SelectedValue.ToString())
        End If
    End Sub

    Protected Sub GV_pnl_IngresoARV_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GV_pnl_IngresoARV.RowCommand
        ...
        If e.CommandName = "Borrar" Then
            ...
            Else
                ...
                Dim rp As String() = x.Split("|")
                If rp(0) = "True" Then
                    llenaMedARV(DDL_mes.SelectedValue.ToString(), DDL_anio.SelectedValue.ToString(), fechasistema)
                    lbl_error.Text = rp(1)
                Else
                    lbl_error.Text = rp(1)
                End If
    ...
    Protected Sub GV_pnl_IngresoARV_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles GV_pnl_IngresoARV.PreRender
        Dim n As Integer = 0
        For Each nrow As GridViewRow In GV_pnl_IngresoARV.Rows
            For columnIndex As Integer = n To Convert.ToInt32(GV_pnl_IngresoARV.Rows.Count)
    ...
    Protected Sub GV_pnl_IngresoARV_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GV_pnl_IngresoARV.RowDataBound
