<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RConsultas.aspx.vb" EnableSessionState="True" Inherits="RConsultas" %>
            ...
            <tr>
                <td>
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="GV_rconsultaspx" runat="server" 
                                CellPadding="1" 
                                ForeColor="#333333" 
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Titulo">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_TITULO" runat="server" Text='<%# Bind("TITULO") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Width="120px" HorizontalAlign="Left" CssClass="GV_rowpad" />
                                        <HeaderStyle Width="120px" HorizontalAlign="Center" CssClass="GV_rowpad" />
                                    </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="TOTAL">
                                    ...
                                    <ItemStyle Width="45px" HorizontalAlign="Right" Font-Bold="true" BackColor="#e9ecf1" CssClass="GV_rowpad" />
                                    <HeaderStyle Width="45px" HorizontalAlign="Center" CssClass="GV_rowpad" />
                                </asp:TemplateField>
                            </Columns>
