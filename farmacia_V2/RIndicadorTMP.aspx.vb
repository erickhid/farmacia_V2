...
Partial Class RIndicadorTMP
    ...
    Protected Sub btn_grabar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_grabar.Click
        ...
        db.Cn1 = cn1
        usuario = Session("usuario").ToString()
        Dim tbpacA As DataTable = db.RIndicadorTMP(fechaA, fechaM, ultimodia, usuario)
        Session("dspacA") = tbpacA
        GV_TMP.DataSource = tbpacA
        GV_TMP.DataBind()
    End Sub

    Private _TOTAL As Integer
    Protected Sub GV_TMP_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GV_TMP.RowDataBound
    ...
    Sub exportar()
        Dim nombre As String = "RIndicadorTMP_" & nombremes(DDL_mes.SelectedValue) & DDL_ano.SelectedValue
        Response.Clear()
