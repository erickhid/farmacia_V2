...
Partial Class RPxTMP
    ...
    Protected Sub btn_grabar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_grabar.Click
        ...
        db.Cn1 = cn1
        usuario = Session("usuario").ToString()
        Dim tbpacA As DataTable = db.RPxActivosTMP(fechaA, fechaM, ultimodia, usuario)
    ...
    Sub exportar()
        Dim nombre As String = "PxActivosTMP_" & nombremes(DDL_mes.SelectedValue) & DDL_ano.SelectedValue
        Response.Clear()
