<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Rep_Ingreso_medicamento.aspx.vb" Inherits="Rep_Ingreo_medicamento" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <div style="width: 775px; border: solid 1px #5d7b9d; text-align:left;">
            <table id="tbl_ingresomed_inventario" border="0" cellpadding="2" cellspacing="1">
                <tr>
                    <th colspan="11" class="theader">
                        REPORTE INGRESO MEDICAMENTO</th>
                </tr>                            
                <tr>
            ...
            <asp:Panel ID="pnl_reporte" runat="server" BorderColor="#5d7b9d" BorderStyle="solid" BorderWidth="0px" Height="500px"  ScrollBars="Auto" Width="100%">
                <table id="tbl_reporte" runat="server" border="0" cellpadding="0" cellspacing="0"  width="950px">
                    <tr>
                        <td>
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode ="Conditional">
                                <ContentTemplate>
                                    <div style="text-align:center" class="theader2"><asp:Label ID="lbl_titulo" runat="server"></asp:Label></div>
                                    <asp:GridView ID="RIM_reportes" runat="server" CellPadding="1" ForeColor="#333333" GridLines="both" BorderColor="#a0acc0" BorderStyle="Solid" BorderWidth="1px" With="950px" ShowFooter="False" AutoGenerateColumns="False"> <RowStyle BackColor="#F7F6F3" ForeColor="#333333" CssClass="GV_rowpadREP1" />
                                        <Columns>
                                             <asp:TemplateField HeaderText="Fecha Ingreso">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_Fecha_Ingreso" runat="server" Text='<%# Bind("Fecha_Ingreso")%>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Forma farmacéutica">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_NFF" runat="server" Text='<%# Bind("NomFF")%>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Cantidad">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_Cantidad_Ingreso" runat="server" Text='<%# Bind("Cantidad_Ingreso")%>'></asp:Label>
                                                </ItemTemplate>
                                                    <ItemStyle Width="50px" HorizontalAlign="Center" CssClass="GV_rowpad" />
                                                    <HeaderStyle Width="50px" HorizontalAlign="Center" CssClass="GV_rowpad" />
                                             </asp:TemplateField>
                                            <asp:TemplateField HeaderText="No. Requisicion">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_No_Req" runat="server" Text='<%# Bind("No_Requisicion")%>'></asp:Label>
                                                </ItemTemplate>
                                                    <ItemStyle Width="175px" HorizontalAlign="Center" CssClass="GV_rowpad" />
                                                    <HeaderStyle Width="175px" HorizontalAlign="Center" CssClass="GV_rowpad" />
                                             </asp:TemplateField>
                                            <asp:TemplateField HeaderText="No. Lote">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_No_L" runat="server" Text='<%# Bind("No_Lote")%>'></asp:Label>
                                                </ItemTemplate>
                                                    <ItemStyle Width="30px" HorizontalAlign="Center" CssClass="GV_rowpad" />
                                                    <HeaderStyle Width="30px" HorizontalAlign="Center" CssClass="GV_rowpad" />
                                             </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Fecha vencimiento">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_FV" runat="server" Text='<%# Bind("Fecha_Vencimiento")%>'></asp:Label>
                                                </ItemTemplate>
                                                    <ItemStyle Width="125px" HorizontalAlign="Center" CssClass="GV_rowpad" />
                                                    <HeaderStyle Width="125px" HorizontalAlign="Center" CssClass="GV_rowpad" />
                                             </asp:TemplateField>
