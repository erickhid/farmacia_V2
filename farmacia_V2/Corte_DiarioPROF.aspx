<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Corte_DiarioPROF.aspx.vb" Inherits="Corte_DiarioPROF" %>
        ...
        <div style="width: 770px; border: solid 1px #5d7b9d; text-align:center;">
            <table id="tbl_ingresomed_inventario" border="0" cellpadding="2" cellspacing="1" style="width: 770px">
                <tr style="width:770px;">
                    <th colspan="16" class="theader">CORTE DIARIO EXISTENCIAS PROF</th>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td style="text-align:left">
                        <asp:ImageButton ID="ibt_generar" runat="server" ImageUrl="~/images/Corte_med_PROF.png" ToolTip="Generar" />
                    </td>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="GV_pnl_CorteARV" runat="server" ForeColor="#333333"
                                        ...
                                        ShowFooter="False" DataKeyNames="IdFFPROF" TabIndex="3">
                                        <RowStyle BackColor="#F7F6F3" ForeColor="#333333" Wrap="False" />
                                        <Columns>
                                            <asp:TemplateField ShowHeader="False" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_IdIngresoMed" runat="server" Text='<%# Bind("IdFFPROF")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
