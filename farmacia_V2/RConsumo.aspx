<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RConsumo.aspx.vb" EnableSessionState="True" Inherits="RConsumo" %>
            ...
            <tr>
                ...
                <td style="width: 100px; background-color: #e9ecf1;">
                    <asp:DropDownList ID="DDL_tipoR" runat="server" CssClass="datos">
                        ...
                        <asp:ListItem Value="6">MEDICAMENTOS</asp:ListItem>
                        <asp:ListItem Value="2">PROFILAXIS</asp:ListItem>
                        <asp:ListItem Value="3">ITS</asp:ListItem>
                        <asp:ListItem Value="4">IO</asp:ListItem>
