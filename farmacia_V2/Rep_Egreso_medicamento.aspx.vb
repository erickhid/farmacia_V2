Imports System.Data
Partial Class Rep_Egreso_medicamento
    ...
    Protected Sub btn_Generar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_Generar.Click
        ...
        Select Case ddl_Medicamento.SelectedValue
            Case 1
                ...
                usuario = Session("usuario").ToString()
                db.Cn1 = cn1
                Dim RepIngresoMedicamento As DataTable = db.RepEgresoMedicamentoARV(fechaA, fechaM, ultimodia, usuario)
                Try
                    Session("dspacA") = RepIngresoMedicamento
                    ROM_reportes.DataSource = RepIngresoMedicamento
                    ROM_reportes.DataBind()
                    lbl_titulo.Text = "Egreso Medicamento  " & nombremes(DDL_Mes.SelectedValue) & " " & DLL_Año.SelectedValue
            ...
            Case 2
                ...
                usuario = Session("usuario").ToString()
                db.Cn1 = cn1
                Dim RepIngresoMedicamento As DataTable = db.RepEgresoMedicamentoPROF(fechaA, fechaM, ultimodia, usuario)
                Try
                    Session("dspacA") = RepIngresoMedicamento
                    ROM_reportes.DataSource = RepIngresoMedicamento
                    ROM_reportes.DataBind()
    ...
    Sub exportar()
        Dim nombre As String = "Rep_Egreso_medicamento" & nombremes(DDL_Mes.SelectedValue) & DLL_Año.SelectedValue()
        Response.Clear()
    ...
    Protected Sub ROM_reportes_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ROM_reportes.SelectedIndexChanged
