...
Partial Class RVisitas
    ...
    Protected Sub btn_grabar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_grabar.Click
        ...
        usuario = Session("usuario").ToString()
        db.Cn1 = cn1
        Dim tbpac As DataTable = db.ListaConsultasPX(fechaA, fechaM, ultimodia, usuario)
        GV_reportes.DataSource = tbpac
        GV_reportes.DataBind()
        lbl_titulo.Text = CStr(tbpac.Rows.Count.ToString()) & " Consultas"
    End Sub
    ...
    Protected Sub IB_exportar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles IB_exportar.Click
        Dim nombre As String = "LConsultasPX_" & nombremes(DDL_mes.SelectedValue) & DDL_ano.SelectedValue
        Response.Clear()
