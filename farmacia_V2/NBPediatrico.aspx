<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="NBPediatrico.aspx.vb" Inherits="NBPediatrico" %>
            ...
            <tr>
                ...
                <td style="width:550px; background-color: #e9ecf1; padding:0px;">
                    <table id="tbl_cal" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td>
                                <asp:TextBox ID="txt_nacimiento" runat="server" CssClass="datos" Width="70px"></asp:TextBox>
                            ...
                            <td style="padding:0px;">
                                <cc1:CalendarExtender ID="txt_nacimiento_CalendarExtender" runat="server" 
                                    Format="dd/MM/yyyy" PopupButtonID="img_cal" 
                                    TargetControlID="txt_nacimiento" CssClass="MyCalendar">
