<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="IngresoMed_Inventario_PROF.aspx.vb" Inherits="IngresoMed_Inventario_PROF" %>
        ...
        <div style="width: 770px; border: solid 1px #5d7b9d; text-align:center;">
            <table id="tbl_ingresomed_inventario" border="0" cellpadding="2" cellspacing="1" style="width: 770px">
                <tr style="width:770px;">
                    <th colspan="16" class="theader">INGRESO INVENTARIO PROFILAXIS</th>
                </tr>
                <tr>
...
<%--<tr>
        ...
        <div>
            <asp:Panel ID="pnl_IngresoPROF1" runat="server">
                <table id="tbl_IPROF" border="0" cellpadding="0" cellspacing="1" style="width:770px;">
                    <tr>
                        <td>
                            <table id="Table8" border="0" cellpadding="0" cellspacing="0" style="width:768px;">
                                <tr>
                                    <th class="theader" style="width:20px;"><asp:ImageButton ID="ib_IngresoPROF" ImageUrl="~/images/plus2.png" runat="server" BorderWidth="0"  Height="10px" Width="10px"/></th>
                                    <th class="theader4">INGRESO PROFILAXIS</th>
                                </tr>
                            </table>
                        </td>
                    </tr>
            ...
            <div >
            <asp:Panel ID="pnl_IngresoPROF" runat="server">
                <asp:UpdatePanel ID="up_pnl_IngresoPROF" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <table id="tblpnl_IngresoPROF" border="0" cellpadding="0" cellspacing="0" style="width:850px;">
                            <tr>
                                <td>
                                    <asp:GridView ID="GV_pnl_IngresoPROF" runat="server" ForeColor="#333333"
                                        EmptyDataText="No se existe ningun ingreso del día de hoy." 
                                        Font-Names="Trebuchet MS" Font-Size="8pt" GridLines="None"
                                        CellPadding="0" CellSpacing="1" Width="850px"  AutoGenerateColumns="False" 
                            ...
                            <tr>
                                <td style="border-top:2px solid #5d7b9d; border-bottom:2px solid #5d7b9d; background-color:#e9ecf1;">
                                    <div id="divingresoGF" runat="server" visible="true">
                                        <table border="0" cellspacing="1" cellpadding="0" width="770px">
                                            <tr>
                                                <td style="text-align:center; width:119px;" class="GV_rowpad">
<%--                                                    <asp:TextBox ID="txt_fechaingreso" runat="server" Width="60px" CssClass="texto2" TabIndex="10"></asp:TextBox>
                                    ...
                                    <cc1:FilteredTextBoxExtender ID="txt_fe_yy_FilteredTextBoxExtender" runat="server"
                                        TargetControlID="txt_fe_yy" ValidChars="0123456789">
                                                ...
                                                <td style="text-align:center; width:144px;" class="GV_rowpad">
                                                    <asp:DropDownList ID="DDL_PROF" runat="server" CssClass="datos" 
                                                        AutoPostBack="true" TabIndex="5">
                                                    </asp:DropDownList>
                                                </td>
                                                <td style="text-align:center; width:154px;" class="GV_rowpad">
                                                    <asp:Label ID="NomPROF" runat="server" Text=""></asp:Label>
                                                </td>
                                              
                                                
                                                <td style="text-align:center; width:37px;" class="GV_rowpad">
                                                    <asp:TextBox ID="txt_cantidadPROF" runat="server" Width="40px" CssClass="texto2" TabIndex="6">0</asp:TextBox>
<%--                                                    <cc1:FilteredTextBoxExtender ID="ftbe_ingresosPROF" runat="server" TargetControlID="txt_cantidadPROF" ValidChars="0123456789">
                                                    </cc1:FilteredTextBoxExtender>--%>
                                                </td>      
...
<%--                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" TargetControlID="txt_no_req" ValidChars="0123456789">
                                                ...
                                                <td style="text-align:center; width:50px;" class="GV_rowpad">
...
<%--                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" TargetControlID="txt_lote" ValidChars="0123456789">
                                        ...
                                        <td style="text-align:center; width:100px;" class="GV_rowpad">
<%--                                                    <asp:TextBox ID="txt_fechaingreso" runat="server" Width="60px" CssClass="texto2" TabIndex="10"></asp:TextBox>
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" TargetControlID="txt_fechaingreso" ValidChars="0123456789/">
                                                    </cc1:FilteredTextBoxExtender>--%>
                                    ...
                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server"
                                        TargetControlID="txt_fe_yy_ven" ValidChars="0123456789">
                                                ...
                                                <td style="text-align:right; width:50px;" class="GV_rowpad">
                                                    ...
                                                    <asp:ImageButton ID="ibt_Modificar" runat="server" ImageUrl="~/images/edit.png" OnClick="ibt_Modificar_Click" ToolTip="Modificar" Visible="false" style="width: 16px"  />
            ...
            SuppressPostBack="true" ExpandedImage="~/images/minus2.png" TargetControlID="pnl_IngresoPROF"
            CollapseControlID="pnl_IngresoPROF1" ExpandControlID="pnl_IngresoPROF1" CollapsedImage="~/images/plus2.png"
            Collapsed="true" ImageControlID="ib_IngresoPROF">
