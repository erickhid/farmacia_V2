<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RPxTMP.aspx.vb" EnableSessionState="True" Inherits="RPxTMP" %>
        ...
        <table id="tblbasal" border="0" cellpadding="2" cellspacing="1">
            <tr>
                <th colspan="7" class="theader">
                    PACIENTES ACTIVOS TRIMETROPIN</th>
            </tr>
            <tr>
                                ...
                                <asp:GridView ID="GV_TMP" runat="server" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Edad">
                                         ...
                                         <asp:TemplateField HeaderText="Fecha Tratamiento">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_FechaInicioTTM" runat="server" Text='<%# Eval("FechaInicioTTM", "{0:dd/MM/yyyy}") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" CssClass="GV_rowpad" />
                                            <HeaderStyle HorizontalAlign="Center" CssClass="GV_rowpad" />
                                        </asp:TemplateField>
