<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RPxConsultas.aspx.vb" EnableSessionState="True" Inherits="RVisitas" %>
        ...
        <table id="tblbasal" border="0" cellpadding="2" cellspacing="1">
            <tr>
                <th colspan="7" class="theader">
                    LISTADO CONSULTAS PACIENTES</th>
            </tr>
            <tr>
                                ...
                                <asp:GridView ID="GV_reportes" runat="server" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Fecha Visita">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_FechaVisita" runat="server" Text='<%# Bind("FechaVisita") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" CssClass="GV_rowpad" />
                                            <HeaderStyle HorizontalAlign="Center" CssClass="GV_rowpad" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="ARV">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_ARV" runat="server" Text='<%# Bind("ARV") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" CssClass="GV_rowpad" />
                                            <HeaderStyle HorizontalAlign="Center" CssClass="GV_rowpad" />
                                        </asp:TemplateField>
