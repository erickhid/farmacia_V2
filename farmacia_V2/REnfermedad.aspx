<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="REnfermedad.aspx.vb" EnableSessionState="True" Inherits="REnfermedad" %>
            ...
            <tr>
                ...
                <td style="width: 100px; background-color: #e9ecf1;">
                    <asp:DropDownList ID="DDL_tipoR" runat="server" CssClass="datos">
                        <asp:ListItem Value="1">DEFINITORIA</asp:ListItem>
                        <asp:ListItem Value="2">RELACIONADA</asp:ListItem>
                        <asp:ListItem Value="3">GENERAL</asp:ListItem>
                        <asp:ListItem Value="4">ITS</asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td style="width: 50px; background-color: #5d7b9d; color: #ffffff;">
                    MES:
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="pnl_reporte" runat="server" BorderColor="#5d7b9d" BorderStyle="solid" BorderWidth="0px" ScrollBars="Auto" Width="698px">
                    <table id="tbl_reporte" runat="server" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td>
                                <asp:GridView ID="GV_renfermedad" runat="server" 
                                    CellPadding="1" 
                                    ForeColor="#333333" 
